...
Validate local inputs with `scripts/check_paths.py`. Render a Markdown draft using `brand-voice.md` when it
exists, then run `scripts/check_fidelity.py` against the collected source. The human edits the draft during
